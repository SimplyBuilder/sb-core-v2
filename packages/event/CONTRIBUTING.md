### Contributing to `@simplybuilder/core-event`
Thank you for considering contributing to `@simplybuilder/core-event`!     
This document contains a set of guidelines for contributing to `@simplybuilder/core-event`.      
