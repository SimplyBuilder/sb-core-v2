### Contributing to `@simplybuilder/core`
Thank you for considering contributing to `@simplybuilder/core`!     
This document contains a set of guidelines for contributing to `@simplybuilder/core`.      
